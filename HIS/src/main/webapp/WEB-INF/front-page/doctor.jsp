			...
			<table>
				...
				<tr>
					...
					<td class="td_3_datetime">
						<input class="datetime" type="time" name="work_time" id="work_time" value="${doctor.work_time }"/> —
						<input class="datetime" type="time" name="outwork_time" id="outwork_time" value="${doctor.outwork_time }"/>
					</td>
				</tr>
			</table>
