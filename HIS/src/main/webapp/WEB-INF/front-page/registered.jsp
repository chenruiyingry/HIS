	...
	<div class="main" id="main">
		<div class="main_bar">
			...
			<table>
				<tr>
					<td>姓名：</td>
					<td><input type="text" id="name" style="width: 70%;" name="name"></td>
					...
					<td>年龄：</td>
					<td style="width: 12%;"><input type="text" id="age" style="width: 70%;" name="age"></td>
				...
				<tr>
					<td>现病史</td>
					<td colspan="9" class="td_9"><input type="text" id="present_illness" name="present_illness"></td>
				</tr>
				<tr>
					<td>既病史</td>
					<td colspan="9" class="td_9"><input type="text" id="past_illness" name="past_illness"></td>
				</tr>
				<tr>
					<td>过敏史</td>
					<td colspan="9" class="td_9"><input type="text" id="allergy" name="allergy"></td>
				</tr>
				<tr>
					<td>家庭地址：</td>
					<td colspan="4"><input type="text" id="address" style="width: 90%;" name="address"></td>
					<td>联系电话：</td>
					<td colspan="4"><input type="text" id="phone" style="width: 40%;" name="phone"></td>
				</tr>
			</table>
		</div>
	</div>
